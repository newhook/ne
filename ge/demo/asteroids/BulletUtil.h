...
btBvhTriangleMeshShape* builtBtBvhTriangleMeshShape(const std::shared_ptr<ge::Mesh>& mesh);

btConvexHullShape* buildBtConvexHull(const std::shared_ptr<ge::Mesh>& mesh, const glm::vec3& scale);
}